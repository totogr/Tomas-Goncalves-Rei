...
import { ProfessionalSignupFormSchema, ProfessionalSignupRequest } from "@/models/Login";
import styles from "@/components/SignUp/SignUp.module.css";

type Props = {
    onSubmit: (value: ProfessionalSignupRequest) => void;
    submitError: Error | null;
};

export function ProfessionalSignup({ onSubmit, submitError }: Props) {
    const form = useAppForm({
        ...
        validators: { onSubmit: ProfessionalSignupFormSchema },
        ...
        <div className={styles.container}>
            <div className={styles.left}>
                <div className={styles.leftContent}>
                    ...
                    <ul className={styles.features}>
                        {["Agenda gratis", "Organizá, reservá y controlá tus citas", "Agenda activa en minutos", "Todo en un solo lugar"].map((text) => (
                            <li key={text}>
            ...
            <div className={styles.right}>
                <div className={styles.formBox}>
                    ...
                    <p className={styles.subtitle}>Empezá a organizar tus citas en minutos</p>

                    <div className={styles.roleTabs}>
                        <a href="/signup/client" className={styles.roleTab}>Cliente</a>
                        <span className={`${styles.roleTab} ${styles.active}`}>Profesional</span>
                    </div>
