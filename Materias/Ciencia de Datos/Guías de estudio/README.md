# Guías de estudio — Ciencia de Datos

Guías pensadas para **llegar a cada clase con el tema leído y entendido a grandes rasgos**: en vez de texto plano, cada una tiene analogías, tablas, diagramas y preguntas de autoevaluación.

> ✅ = guía lista y fundamentada en material de la cátedra · 🟡 = lista pero **preliminar** (basada en el plan de estudios, se completa cuando llegue la slide).

| # | Tema | Estado |
| --- | --- | --- |
| 01 | [Introducción a la materia](01%20-%20Introducci%C3%B3n%20a%20la%20materia.md) | ✅ |
